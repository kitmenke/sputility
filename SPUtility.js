...
var SPUtility = (function ($) {
   ...
   **/
    ...
    *   Supports Single value of taxonomy fields
    *   Added by Sankar Kumar Darapu
    */
   function SPTaxonomyField(fieldParams, hiddenInputs) {
       SPField.call(this, fieldParams);
       // public Textbox property
       this.Textbox = hiddenInputs[0];
   }

    // SPFieldTaxonomyField inherits from the SPField base class
   SPTaxonomyField.prototype = Object.create(SPField.prototype);

    /*
     *   SPFieldTaxonomyField Public Methods
     *   Overrides SPField class methods.
     */
   ...
   SPTaxonomyField.prototype.GetValueText = function () {
   ...
   SPTaxonomyField.prototype.GetValueGuid = function () {
       var val = this.GetValue().split("|");
       if (val.length == 2 && val[1] != "00000000-0000-0000-0000-000000000000") {
           return val[1];
       }
       return;
   };
   ...
   */
   ...
   function getSPFieldFromType(spFieldParams) {
      ...
      case 'SPFieldTaxonomyFieldType':
          controls = $(spFieldParams.controlsCell).find('input[type="hidden"]');
          if (controls.length >= 1) {
              field = new SPTaxonomyField(spFieldParams, controls);
          }
         break;
      default:
